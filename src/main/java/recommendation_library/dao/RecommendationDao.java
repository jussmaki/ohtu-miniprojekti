...
public interface RecommendationDao {
    ...
    List<Recommendation> getRecommendationsWithTag(String tag);


    List<BookRecommendation> getBooksWithTag(String tag);

    List<VideoRecommendation> getVideosWithTag(String tag);

    List<PodcastRecommendation> getPodcastsWithTag(String tag);

    List<BlogRecommendation> getBlogsWithTag(String tag);
}
